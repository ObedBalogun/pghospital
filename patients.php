<?php
    session_start();
    $patient_list = $_SESSION['patients_list'];
						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<?php
									...
									print_r("<tr>
										<td><img width=\"28\" height=\"28\" src=\"assets/img/user.jpg\" class=\"rounded-circle m-r-5\">". $patient['PAT_NAME']."</td>".
										"<td><img width=\"28\" height=\"28\" src=\"assets/img/user.jpg\" class=\"rounded-circle m-r-5\">". $patient['PAT_DOB']."</td>".
										"<td><img width=\"28\" height=\"28\" src=\"assets/img/user.jpg\" class=\"rounded-circle m-r-5\">". $patient['PAT_ADDR']."</td>".
										"<td><img width=\"28\" height=\"28\" src=\"assets/img/user.jpg\" class=\"rounded-circle m-r-5\">0". $patient['PAT_PHONE']."</td>".
										"<td class=\"text-right\">
